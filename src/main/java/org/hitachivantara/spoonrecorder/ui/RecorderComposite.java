...
import org.hitachivantara.spoonrecorder.adapters.RecordSelectionAdapter;
import org.hitachivantara.spoonrecorder.listeners.SaveSelectionListener;
...
public class RecorderComposite extends Composite {
  public RecorderComposite( Composite composite, int i ) {
    ...
    saveBtn.addSelectionListener( new SaveSelectionListener( composite.getParent().getShell() ) );
  }
}
